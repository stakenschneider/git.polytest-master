...
Mat NLMeansFilterc(Mat& source, int diameter, double sigmaI) {
...
void GaussFilterOwn(Mat& img, int kernelSize) {
	Mat gauss;
...
void BilateralFilterOwn(Mat source, Mat filteredImage, int x, int y, int diameter, double sigmaI, double sigmaS, int height, int width) {
	double iFiltered = 0;
	double wP = 0;
	int neighbor_x = 0;
	int neighbor_y = 0;
