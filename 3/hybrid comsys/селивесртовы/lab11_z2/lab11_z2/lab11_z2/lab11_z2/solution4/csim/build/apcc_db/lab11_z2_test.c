...
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = call i32 bitcast (i32 (...)* @foo to i32 (i32*, i32*)*)(i32* %%1, i32* %%33) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_309_count);
  foo((signed int *)llvm_cbe_tmp__1, (signed int *)llvm_cbe_tmp__33);
if (AESL_DEBUG_TRACE) {
...
llvm_cbe_tmp__42:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge13 = phi i32 [ 0, %%0 ], [ %%42, %%35  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge13_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = sext i32 %%storemerge13 to i64, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_325_count);
  llvm_cbe_tmp__35 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge13);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__35);
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = getelementptr inbounds [16 x i32]* %%d_expected, i64 0, i64 %%36, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_326_count);
  llvm_cbe_tmp__36 = (signed int *)(&llvm_cbe_d_expected[(((signed long long )llvm_cbe_tmp__35))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__35) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'd_expected' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = load i32* %%37, align 4, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_327_count);
  llvm_cbe_tmp__37 = (unsigned int )*llvm_cbe_tmp__36;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds [16 x i32]* %%d_actual, i64 0, i64 %%36, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_328_count);
  llvm_cbe_tmp__38 = (signed int *)(&llvm_cbe_d_actual[(((signed long long )llvm_cbe_tmp__35))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__35) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'd_actual' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = load i32* %%39, align 4, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_329_count);
  llvm_cbe_tmp__39 = (unsigned int )*llvm_cbe_tmp__38;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%38, i32 %%40) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_330_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = add nsw i32 %%storemerge13, 1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_331_count);
  llvm_cbe_tmp__41 = (unsigned int )((unsigned int )(llvm_cbe_storemerge13&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__41&4294967295ull)));
  if (((llvm_cbe_tmp__41&4294967295U) == (16u&4294967295U))) {
    goto llvm_cbe_tmp__43;
  } else {
    llvm_cbe_storemerge13__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__41;   /* for PHI node */
    goto llvm_cbe_tmp__42;
  }
