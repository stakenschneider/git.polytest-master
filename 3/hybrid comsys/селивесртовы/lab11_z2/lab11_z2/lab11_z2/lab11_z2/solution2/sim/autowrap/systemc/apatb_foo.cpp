...
int d_out[16])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *d_out_pc_buffer = new sc_bv<32>[16];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: d_out
				{
					...
					// {
						// celement: d_out(31, 0)
						// {
							sc_lv<32>* d_out_lv0_0_15_1 = new sc_lv<32>[16];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: d_out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 15; i_0 += 1)
							{
								...
								{
									d_out_lv0_0_15_1[hls_map_index].range(31, 0) = sc_bv<32>(d_out_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: d_out(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 15; i_0 += 1)
							{
								...
								// output_type_conversion : (d_out_lv0_0_15_1[hls_map_index]).to_uint64()
								if (&(d_out[0]) != NULL) // check the null address if the c port is array or others
								{
									d_out[i_0] = (d_out_lv0_0_15_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* d_in_tvin_wrapc_buffer = new sc_bv<32>[16];
		...
		tcl_file.set_num(16, &tcl_file.d_in_depth);
		...
		sc_bv<32>* d_out_tvin_wrapc_buffer = new sc_bv<32>[16];
		...
		tcl_file.set_num(16, &tcl_file.d_out_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* d_out_tvout_wrapc_buffer = new sc_bv<32>[16];
