...
signed int AESL_WRAP_lab1_1( char ,  char ,  char ,  char );
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = tail call i32 @AESL_WRAP_lab1_1(i8 signext 10, i8 signext 20, i8 signext 30, i8 signext 40) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__1 = (unsigned int ) /*tail*/ AESL_WRAP_lab1_1(((unsigned char )10), ((unsigned char )20), ((unsigned char )30), ((unsigned char )40));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )10));
printf("\nArgument  = 0x%X",((unsigned char )20));
printf("\nArgument  = 0x%X",((unsigned char )30));
printf("\nArgument  = 0x%X",((unsigned char )40));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = tail call i32 @AESL_WRAP_lab1_1(i8 signext 20, i8 signext 30, i8 signext 40, i8 signext 50) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  llvm_cbe_tmp__5 = (unsigned int ) /*tail*/ AESL_WRAP_lab1_1(((unsigned char )20), ((unsigned char )30), ((unsigned char )40), ((unsigned char )50));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )20));
printf("\nArgument  = 0x%X",((unsigned char )30));
printf("\nArgument  = 0x%X",((unsigned char )40));
printf("\nArgument  = 0x%X",((unsigned char )50));
...
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = tail call i32 @AESL_WRAP_lab1_1(i8 signext 30, i8 signext 40, i8 signext 50, i8 signext 60) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__9 = (unsigned int ) /*tail*/ AESL_WRAP_lab1_1(((unsigned char )30), ((unsigned char )40), ((unsigned char )50), ((unsigned char )60));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",((unsigned char )30));
printf("\nArgument  = 0x%X",((unsigned char )40));
printf("\nArgument  = 0x%X",((unsigned char )50));
printf("\nArgument  = 0x%X",((unsigned char )60));
