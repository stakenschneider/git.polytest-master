...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab1_1.autotvin_a.dat"
         "c.lab1_1.autotvin_b.dat"
         "c.lab1_1.autotvin_c.dat"
         "c.lab1_1.autotvin_d.dat"
         "c.lab1_1.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab1_1.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
