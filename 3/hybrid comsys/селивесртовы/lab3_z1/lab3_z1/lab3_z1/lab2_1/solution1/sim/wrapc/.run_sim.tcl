...
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.1/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Program_Files/Xilinx/Vivado/2019.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "lab1_1.autotvin.dat"
	set constFileTvOut       "lab1_1.autotvout.dat"
	set constFileHdlTvIn     "lab1_1.autohdltvin.dat"
	set constFileHdlTvOut    "lab1_1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
