...
lab1_1::lab1_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    lab1_1_mac_muladdbkb_U1->din2(add_ln4_reg_95);
    lab1_1_mac_muladdbkb_U1->ce(grp_fu_76_ce);
    lab1_1_mac_muladdbkb_U1->dout(grp_fu_76_p3);
    ...
    SC_METHOD(thread_sext_ln4_5_fu_73_p1);
    sensitive << ( grp_fu_76_p3 );
    ...
    sc_trace(mVcdFile, add_ln4_reg_95, "add_ln4_reg_95");
    ...
    sc_trace(mVcdFile, grp_fu_76_p3, "grp_fu_76_p3");
    sc_trace(mVcdFile, sext_ln4_5_fu_73_p1, "sext_ln4_5_fu_73_p1");
...
void lab1_1::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
            ap_return_preg = sext_ln4_5_fu_73_p1.read();
        }
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        add_ln4_reg_95 = add_ln4_fu_64_p2.read();
    }
}
...
void lab1_1::thread_ap_block_state1() {
...
void lab1_1::thread_ap_return() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        ap_return = sext_ln4_5_fu_73_p1.read();
    } else {
        ap_return = ap_return_preg.read();
    }
}

void lab1_1::thread_grp_fu_76_ce() {
...
void lab1_1::thread_sext_ln4_5_fu_73_p1() {
    sext_ln4_5_fu_73_p1 = esl_sext<32,16>(grp_fu_76_p3.read());
}
