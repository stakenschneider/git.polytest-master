...
architecture behav of lab1_2 is 
    ...
    "lab1_2,hls_ip_2019_1,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xa7a12t-csg325-1Q,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.470000,HLS_SYN_LAT=13,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=2,HLS_SYN_FF=139,HLS_SYN_LUT=136,HLS_VERSION=2019_1}";
...
begin
    ...
    mul_ln5_fu_124_p1 <= sext_ln5_reg_133(8 - 1 downto 0);
    mul_ln5_fu_124_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(signed(x_reg_161) * signed(mul_ln5_fu_124_p1))), 32));
