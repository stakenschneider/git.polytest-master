...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab1_2.autotvin_in_r.dat"
         "c.lab1_2.autotvin_a.dat"
         "c.lab1_2.autotvin_b.dat"
         "c.lab1_2.autotvin_c.dat"
         "c.lab1_2.autotvin_out_r.dat"
         "c.lab1_2.autotvout_out_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab1_2.autotvout_out_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
