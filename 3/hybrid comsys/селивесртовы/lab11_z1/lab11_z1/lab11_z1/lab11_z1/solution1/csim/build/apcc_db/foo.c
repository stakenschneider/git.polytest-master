...
void foo(signed int *llvm_cbe_a, signed int *llvm_cbe_b, signed int *llvm_cbe_c);
...
llvm_cbe_tmp__9:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 0, %%0 ], [ %%9, %%1  for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%storemerge1 to i64, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_14_count);
  llvm_cbe_tmp__1 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds i32* %%b, i64 %%2, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_15_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds i32* %%c, i64 %%2, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_17_count);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = add nsw i32 %%6, %%4, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_19_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds i32* %%a, i64 %%2, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__7 = (signed int *)(&llvm_cbe_a[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%7, i32* %%8, align 4, !dbg !2 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_21_count);
  *llvm_cbe_tmp__7 = llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge1, 1, !dbg !3 for 0x%I64xth hint within @foo  --> \n", ++aesl_llvm_cbe_22_count);
