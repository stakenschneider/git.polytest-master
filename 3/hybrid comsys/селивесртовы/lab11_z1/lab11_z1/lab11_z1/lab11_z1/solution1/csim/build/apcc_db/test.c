...
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = call i32 bitcast (i32 (...)* @foo to i32 (i32*, i32*, i32*)*)(i32* %%11, i32* %%12, i32* %%13) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_57_count);
  foo((signed int *)llvm_cbe_tmp__9, (signed int *)llvm_cbe_tmp__10, (signed int *)llvm_cbe_tmp__11);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__12);
}
  llvm_cbe_storemerge13__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
  llvm_cbe_tmp__13__PHI_TEMPORARY = (unsigned int )1u;   /* for PHI node */
  goto llvm_cbe_tmp__24;

  do {     /* Syntactic loop '' to make GCC happy */
llvm_cbe_tmp__24:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge13 = phi i32 [ 0, %%10 ], [ %%25, %%15  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge13_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = phi i32 [ 1, %%10 ], [ %%., %%15  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_76_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = sext i32 %%storemerge13 to i64, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__14 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge13);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds [16 x i32]* %%a_expected, i64 0, i64 %%17, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__15 = (signed int *)(&llvm_cbe_a_expected[(((signed long long )llvm_cbe_tmp__14))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__14) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'a_expected' bound?\n", __FILE__, __LINE__);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = getelementptr inbounds [16 x i32]* %%a_actual, i64 0, i64 %%17, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_80_count);
  llvm_cbe_tmp__17 = (signed int *)(&llvm_cbe_a_actual[(((signed long long )llvm_cbe_tmp__14))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__14) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'a_actual' bound?\n", __FILE__, __LINE__);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([27 x i8]* @aesl_internal_.str, i64 0, i64 0), i32 %%19, i32 %%21) nounwind, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_82_count);
...
#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = load i32* %%20, align 4, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_83_count);
  llvm_cbe_tmp__20 = (unsigned int )*llvm_cbe_tmp__17;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%24, i32 %%16, i32 -1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (unsigned int )((((llvm_cbe_tmp__16&4294967295U) == (llvm_cbe_tmp__20&4294967295U))) ? ((unsigned int )llvm_cbe_tmp__13) : ((unsigned int )4294967295u));
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add nsw i32 %%storemerge13, 1, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_85_count);
  llvm_cbe_tmp__21 = (unsigned int )((unsigned int )(llvm_cbe_storemerge13&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__21&4294967295ull)));
  if (((llvm_cbe_tmp__21&4294967295U) == (16u&4294967295U))) {
    goto llvm_cbe_tmp__25;
  } else {
    llvm_cbe_storemerge13__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__21;   /* for PHI node */
