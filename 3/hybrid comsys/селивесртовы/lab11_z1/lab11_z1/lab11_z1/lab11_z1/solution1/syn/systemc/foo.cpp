...
foo::foo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, i_1_reg_106, "i_1_reg_106");
...
void foo::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_reg_67 = i_1_reg_106.read();
    } else if ((esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()))) {
        i_reg_67 = ap_const_lv5_0;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        i_1_reg_106 = i_1_fu_84_p2.read();
    }
    if ((esl_seteq<1,1,1>(exitcond_fu_78_p2.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
        tmp_reg_111 = tmp_fu_90_p1.read();
    }
}

void foo::thread_a_address0() {
    a_address0 =  (sc_lv<5>) (tmp_reg_111.read());
}
...
void foo::thread_ap_done() {
    if ((esl_seteq<1,1,1>(exitcond_fu_78_p2.read(), ap_const_lv1_1) && 
...
void foo::thread_b_address0() {
    b_address0 =  (sc_lv<5>) (tmp_fu_90_p1.read());
}
...
void foo::thread_c_address0() {
    c_address0 =  (sc_lv<5>) (tmp_fu_90_p1.read());
}
...
void foo::thread_exitcond_fu_78_p2() {
    exitcond_fu_78_p2 = (!i_reg_67.read().is_01() || !ap_const_lv5_11.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_67.read() == ap_const_lv5_11);
}

void foo::thread_i_1_fu_84_p2() {
    i_1_fu_84_p2 = (!i_reg_67.read().is_01() || !ap_const_lv5_1.is_01())? sc_lv<5>(): (sc_biguint<5>(i_reg_67.read()) + sc_biguint<5>(ap_const_lv5_1));
}

void foo::thread_tmp_fu_90_p1() {
    tmp_fu_90_p1 = esl_zext<64,5>(i_reg_67.read());
}
...
void foo::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(exitcond_fu_78_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
