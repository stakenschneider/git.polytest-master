set C_TypeInfoList {{ 
"foo" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"scalar": "int"}, [17]]}] }, {"b": [[], {"array": [ {"scalar": "int"}, [17]]}] }, {"c": [[], {"array": [ {"scalar": "int"}, [17]]}] }],[],""]
}}
set moduleName foo
...
set C_modelArgList {
	{ a int 32 regular {array 17 { 0 0 } 0 1 }  }
	{ b int 32 regular {array 17 { 1 1 } 1 1 }  }
	{ c int 32 regular {array 17 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 16,"step" : 1}]}]}]} , 
 	{ "Name" : "b", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "b","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 16,"step" : 1}]}]}]} , 
 	{ "Name" : "c", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "c","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 16,"step" : 1}]}]}]} ]}
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 5 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 32 }  { a_address1 mem_address 1 5 }  { a_ce1 mem_ce 1 1 }  { a_we1 mem_we 1 1 }  { a_d1 mem_din 1 32 } } }
	...
	c { ap_memory {  { c_address0 mem_address 1 5 }  { c_ce0 mem_ce 1 1 }  { c_q0 mem_dout 0 32 }  { c_address1 mem_address 1 5 }  { c_ce1 mem_ce 1 1 }  { c_q1 mem_dout 0 32 } } }
}
