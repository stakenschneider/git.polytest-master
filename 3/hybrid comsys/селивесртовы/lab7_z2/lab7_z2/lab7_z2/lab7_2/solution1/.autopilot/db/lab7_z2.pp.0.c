...
# 8 "<command line>" 2
# 1 "<built-in>" 2
# 1 "source/lab7_z2.c" 2
void foo (int in1[10][10], int in2[10][10], int out[10][10]) {_ssdm_SpecArrayDimSize(in1, 10);_ssdm_SpecArrayDimSize(in2, 10);_ssdm_SpecArrayDimSize(out, 10);
 int i, j;
 L1:for (i = 0; i < 10; i++) {
  L2:for (j = 0; j < 10; j++) {
