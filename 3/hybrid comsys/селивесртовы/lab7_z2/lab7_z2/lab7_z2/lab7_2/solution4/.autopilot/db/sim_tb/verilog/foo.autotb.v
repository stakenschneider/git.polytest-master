...
`define AUTOTB_TVIN_out_r  "./c.foo.autotvin_out_r.dat"
`define AUTOTB_TVIN_in1_out_wrapc  "./rtl.foo.autotvin_in1.dat"
`define AUTOTB_TVIN_in2_out_wrapc  "./rtl.foo.autotvin_in2.dat"
`define AUTOTB_TVIN_out_r_out_wrapc  "./rtl.foo.autotvin_out_r.dat"
`define AUTOTB_TVOUT_out_r  "./c.foo.autotvout_out_r.dat"
`define AUTOTB_TVOUT_out_r_out_wrapc  "./impl_rtl.foo.autotvout_out_r.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.foo.autotvout_out_r.dat", "r");
    fp2 = $fopen("./impl_rtl.foo.autotvout_out_r.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.foo.autotvout_out_r.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.foo.autotvout_out_r.dat\"!");
    else begin
        $display("Comparing rtl.foo.autotvout_out_r.dat with impl_rtl.foo.autotvout_out_r.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
