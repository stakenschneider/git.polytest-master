...
// ==============================================================
# 1 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c"
# 1 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c" 2
...
#include "apatb_foo.h"
#endif
# 3 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c"
int main() {
 int in1 = 4;
 int in2 = 6;
...
#endif
# 9 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c"
foo(in1,in2,o_p);
#undef foo
# 9 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c"
 ...
 printf("Out %d == Exp %d\n", out, exp_out);
 if (out != exp_out) {
  fprintf((&__iob_func()[1]), "-------ERROR-------\n");
  return -1;
 } else {
  fprintf((&__iob_func()[1]), "-------Test Pass-------\n");
  return 0;
 }
}
#endif
# 19 "D:/Program_Files/projects/hls/lab7_z3/source/lab7_z3_test.c"
