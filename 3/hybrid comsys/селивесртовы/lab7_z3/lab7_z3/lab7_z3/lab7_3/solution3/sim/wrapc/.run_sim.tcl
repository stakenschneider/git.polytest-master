...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "foo.autotvin.dat"
	set constFileTvOut       "foo.autotvout.dat"
	set constFileHdlTvIn     "foo.autohdltvin.dat"
	set constFileHdlTvOut    "foo.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
