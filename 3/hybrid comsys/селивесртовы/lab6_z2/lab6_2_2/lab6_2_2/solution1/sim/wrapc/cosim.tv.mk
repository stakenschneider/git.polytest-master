...
$(ObjDir)/lab6_22test.c_pre.c.tb.o : lab6_22test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab6_22test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/lab6_22main.c_pre.c.tb.o : lab6_22main.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) lab6_22main.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
