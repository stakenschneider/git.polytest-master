...
int* d)
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *d_pc_buffer = new sc_bv<32>[1];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: d
				{
					...
					// {
						// celement: d(31, 0)
						// {
							sc_lv<32>* d_lv0_0_0_1 = new sc_lv<32>[1];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: d(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 0; i_0 += 1)
							{
								...
								{
									d_lv0_0_0_1[hls_map_index].range(31, 0) = sc_bv<32>(d_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* d_tvout_wrapc_buffer = new sc_bv<32>[1];
