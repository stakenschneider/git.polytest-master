# ==============================================================
# File generated on Sun May 05 15:03:30 +0300 2019
...
HLS_SOURCES = ../../../lab11_z2_test.c ../../../foo.c
...
$(ObjDir)/lab11_z2_test.o: ../../../lab11_z2_test.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../lab11_z2_test.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/lab11_z2_test.d
