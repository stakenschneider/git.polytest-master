...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.lab4_1.autotvin_a.dat"
         "c.lab4_1.autotvin_b.dat"
         "c.lab4_1.autotvin_c.dat"
         "c.lab4_1.autotvin_d.dat"
         "c.lab4_1.autotvout_p_y.dat"
         "c.lab4_1.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.lab4_1.autotvout_p_y.dat"
         "rtl.lab4_1.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
