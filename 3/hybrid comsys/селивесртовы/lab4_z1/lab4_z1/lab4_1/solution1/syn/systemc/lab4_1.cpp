...
lab4_1::lab4_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    lab4_1_mul_32s_32bkb_U1->ce(ap_var_for_const0);
    lab4_1_mul_32s_32bkb_U1->dout(grp_fu_55_p2);
    ...
    sc_trace(mVcdFile, p_y_ap_vld, "(port)p_y_ap_vld");
    ...
    sc_trace(mVcdFile, mul_ln3_reg_82, "mul_ln3_reg_82");
...
void lab4_1::thread_ap_var_for_const0() {
...
void lab4_1::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        mul_ln3_reg_82 = grp_fu_55_p2.read();
    }
}
...
void lab4_1::thread_ap_return() {
    ap_return = (!c.read().is_01() || !mul_ln3_reg_82.read().is_01())? sc_lv<32>(): (sc_biguint<32>(c.read()) + sc_biguint<32>(mul_ln3_reg_82.read()));
}

void lab4_1::thread_p_y() {
    p_y = (!d.read().is_01() || !mul_ln3_reg_82.read().is_01())? sc_lv<32>(): (sc_biguint<32>(d.read()) + sc_biguint<32>(mul_ln3_reg_82.read()));
}

void lab4_1::thread_p_y_ap_vld() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        p_y_ap_vld = ap_const_logic_1;
    } else {
        p_y_ap_vld = ap_const_logic_0;
    }
}
...
void lab4_1::thread_hdltv_gen() {
    ...
    while (1) {
        ...
        mHdltvoutHandle << " , " <<  " \"p_y_ap_vld\" :  \"" << p_y_ap_vld.read() << "\" ";
