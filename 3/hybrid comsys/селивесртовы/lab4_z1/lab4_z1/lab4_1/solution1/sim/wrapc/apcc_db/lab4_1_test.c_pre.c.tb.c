...
signed int AESL_WRAP_lab4_1(signed int , signed int , signed int *, signed int *, signed int *);
...
printf("\n = 0x%X\n", 1u);
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = call i32 @AESL_WRAP_lab4_1(i32 10, i32 20, i32* %%inC, i32* %%inD, i32* %%inP) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_40_count);
  llvm_cbe_tmp__1 = (unsigned int )AESL_WRAP_lab4_1(10u, 20u, (signed int *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_inD), (signed int *)(&llvm_cbe_inP));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",10u);
printf("\nArgument  = 0x%X",20u);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = call i32 @AESL_WRAP_lab4_1(i32 20, i32 30, i32* %%inC, i32* %%inD, i32* %%inP) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_120_count);
  llvm_cbe_tmp__15 = (unsigned int )AESL_WRAP_lab4_1(20u, 30u, (signed int *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_inD), (signed int *)(&llvm_cbe_inP));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",20u);
printf("\nArgument  = 0x%X",30u);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__28);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = call i32 @AESL_WRAP_lab4_1(i32 30, i32 40, i32* %%inC, i32* %%inD, i32* %%inP) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_200_count);
  llvm_cbe_tmp__29 = (unsigned int )AESL_WRAP_lab4_1(30u, 40u, (signed int *)(&llvm_cbe_inC), (signed int *)(&llvm_cbe_inD), (signed int *)(&llvm_cbe_inP));
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",30u);
printf("\nArgument  = 0x%X",40u);
