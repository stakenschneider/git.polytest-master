...
printf("\n = 0x%X\n", llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE)
printf("\n  %%15 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%13, i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 0, i32 6, i32 0, i32 %%14) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_115_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__13, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), 0u, 6u, 0u, llvm_cbe_tmp__14);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",0u);
printf("\nArgument  = 0x%X",6u);
printf("\nArgument  = 0x%X",0u);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%18, i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 1, i32 13, i32 1, i32 %%19) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_133_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__18, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), 1u, 13u, 1u, llvm_cbe_tmp__19);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",1u);
printf("\nArgument  = 0x%X",13u);
printf("\nArgument  = 0x%X",1u);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%23, i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 2, i32 21, i32 2, i32 %%24) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_151_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__23, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), 2u, 21u, 2u, llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",2u);
printf("\nArgument  = 0x%X",21u);
printf("\nArgument  = 0x%X",2u);
...
printf("\n = 0x%X\n", llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%28, i8* getelementptr inbounds ([26 x i8]* @aesl_internal_.str2, i64 0, i64 0), i32 3, i32 30, i32 3, i32 %%29) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_169_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__28, ( char *)((&aesl_internal__OC_str2[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 26
#endif
])), 3u, 30u, 3u, llvm_cbe_tmp__29);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",3u);
printf("\nArgument  = 0x%X",30u);
printf("\nArgument  = 0x%X",3u);
...
printf("\n  %%38 = or i1 %%not.7, %%37, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_203_count);
  llvm_cbe_tmp__37 = (bool )((((llvm_cbe_tmp__21&4294967295U) != (13u&4294967295U)) | ((llvm_cbe_tmp__16&4294967295U) != (6u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__37);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = or i1 %%38, %%not.6, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_204_count);
  llvm_cbe_tmp__38 = (bool )((llvm_cbe_tmp__37 | ((llvm_cbe_tmp__26&4294967295U) != (21u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__38);
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = or i1 %%39, %%not.5, !dbg !4 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_205_count);
  llvm_cbe_tmp__39 = (bool )((llvm_cbe_tmp__38 | ((llvm_cbe_tmp__31&4294967295U) != (30u&4294967295U)))&1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__39);
if (AESL_DEBUG_TRACE)
