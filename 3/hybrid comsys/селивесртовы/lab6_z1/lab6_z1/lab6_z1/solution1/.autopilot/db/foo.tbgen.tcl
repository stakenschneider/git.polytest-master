...
set C_modelArgList {
	{ d int 32 regular {array 5 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "d", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "d","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 4,"step" : 1}]}]}]} ]}
...
set portList { 
	...
	{ d_address0 sc_out sc_lv 3 signal 0 } 
...
set ArgLastReadFirstWriteLatency {
	foo {
		d {Type IO LastRead 1 FirstWrite 3}
...
set Spec2ImplPortList { 
	d { ap_memory {  { d_address0 mem_address 1 3 }  { d_ce0 mem_ce 1 1 }  { d_we0 mem_we 1 1 }  { d_d0 mem_din 1 32 }  { d_q0 mem_dout 0 32 } } }
}
