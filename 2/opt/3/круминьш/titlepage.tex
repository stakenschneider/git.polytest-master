%------------------------------------------------
	\begin{titlepage}
		...
		\begin{center}
			...
			\textbf{Тема: } Марковские модели принятия решений}
		\end{center}
		...
		\flushleft{Преподаватель} \hfill\parbox{9 cm}{\hspace*{3cm}\hbox to 0cm{\raisebox{-1em}{\small(подпись)}}\hspace*{-0.8cm}\rule{3cm}{0.8pt} А.Г. Сиднев}\\[0.6cm]
