...
startingPoint = lb;
[x_1, z1_opt] = fmincon(z1, startingPoint, A, b, Aeq, beq, lb, ub)
[x_2, f2_opt] = fmincon(f2, startingPoint, A, b, Aeq, beq, lb, ub)
[x_3, z3_opt] = fmincon(z3, startingPoint, A, b, Aeq, beq, lb, ub)
